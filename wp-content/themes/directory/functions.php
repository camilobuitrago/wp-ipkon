...
function aitEnqueueScriptsAndStyles()
{
	...
	aitAddStyles(array(
		'ait-jquery-colorbox'     => array('file' => "$s/colorbox.css"),
	...
	aitAddScripts(array(
		...
		'ait-jquery-html5placeholder' => array('file' => "$j/libs/jquery.html5placeholder.min.js", 'deps' => array('jquery')),
		'ait-googlemaps-api'          => array('file' => 'http://maps.google.com/maps/api/js?sensor=false&amp;language=en', 'deps' => array('jquery')),
		...
		'ait-jquery-colorbox'         => array('file' => "$j/libs/jquery.colorbox-min.js", 'deps' => array('jquery')),
	...
	wp_localize_script( 'ait-script', 'MyAjax', array( 'ajaxurl' => admin_url( 'admin-ajax.php' ) ) );
}
