<script type="text/javascript">
	...
	jQuery(document).ready(function($) {
        ...
        infobox.setContent('<div class="marker-holder"><div class="marker-content{if !empty($thumbnailDir)} with-image"><img src="{timthumb src => $thumbnailDir, w => 120, h => 160}" alt="">{else}">{/if}<div class="map-item-info"><div class="title">'+{$post->title}+'</div><div class="address">'+{ifset $options["address"]}{$options["address"]|nl2br}+{/ifset}'</div><a href="{!$post->link}" class="more-button">' + {__ 'VIEW MORE'} + '</a></div><div class="arrow"></div><div class="close"></div></div></div></div>');
